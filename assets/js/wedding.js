...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    const weddingGallery = document.getElementById("weddingGallery");
    ...
    try {
        ...
        if (!weddingGallery) {
            throw new Error(
                'Gallery container "#weddingGallery" was not found.'
            );
        }
        ...
        const response = await fetch(
            "assets/image/wedding/wedding.json"
        );
        ...
        if (!Array.isArray(images)) {
            ...
            throw new Error(
                "wedding.json must contain an array."
            );
    ...
    (imageObj, index) => {
        return new Promise((resolve, reject) => {
            ...
            img.src = `assets/image/wedding/${imageObj.file}`;
        });
    }
);
        ...
        //     weddingGallery.appendChild(link);
...
//     wrapper.className = "wedding-photo-item";

//     const link = document.createElement("a");
//     link.href = `assets/image/wedding/${imageObj.file}`;
//     link.className = "wedding-photo";
//     link.target = "_blank";

//     const img = document.createElement("img");
//     img.src = `assets/image/wedding/${imageObj.file}`;
//     img.alt = `wedding portrait ${index + 1}`;
//     img.loading = "eager";
...
//     weddingGallery.appendChild(wrapper);
// });
...
weddingGallery.addEventListener("click", function(e) {
    const photoItem = e.target.closest(".wedding-photo-item");
    if (photoItem) {
